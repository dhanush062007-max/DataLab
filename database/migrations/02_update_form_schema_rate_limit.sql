-- 1. Update function to fetch public form schema safely AND include rate_limit_settings
...
BEGIN
    -- Validate token
    SELECT dataset_id, is_active, rate_limit_settings INTO v_dataset_id, v_is_active, v_rate_limit
