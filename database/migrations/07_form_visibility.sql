-- 1. Add visibility column to collection_forms
ALTER TABLE public.collection_forms ADD COLUMN IF NOT EXISTS visibility VARCHAR DEFAULT 'private';

-- 2. Update function to fetch public form schema safely AND include rate_limit_settings AND visibility
